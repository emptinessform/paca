// spec: features/projects/integration-sidebar.feature
...
/** Navigate to a sprint's integration page and ensure the Board tab is active. */
...
/** Navigate to a sprint's integration page and ensure the Table tab is active. */
...
/** Return the SidebarMenuButton element for a named integration entry in the sidebar. */
...
test.describe('Dragging a task onto a sidebar integration entry reassigns its sprint', () => {
